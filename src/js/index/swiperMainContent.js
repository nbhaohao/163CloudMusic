        ...
        template: `
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" data-swiper="0">
                    <div class="recommendMusicList"></div>
            ...
            this.mySwiper = new Swiper ('main .swiper-container', {
                ...
                on: {
                    ...
                    slideChangeTransitionStart: function(){
                        $("main .swiper-container").height((Number($(`[data-swiper=${this.activeIndex}]`).attr("data-height"))) + "px")
                    },
                    init: function() {
                        $(`[data-swiper='2']`).height($(".page").height() - 5 - $(".header").height() - $(".slidebar").height() + "px")
                        setTimeout(() => {
                            $("main .swiper-container .swiper-slide").each((index, element) => {
                                element.dataset.height = element.clientHeight
                            })
                            $(".line-scale-pulse-out.active").removeClass("active")
                        }, 1000)
